...
public:
    ...
    static void Convert(ResourceLocator& locator, const char* resourceName, const char* outputName)
    {
        std::unique_ptr<ISound> music = locator.LocateSound(resourceName);
        if (!music)
        {
            return;
        }

        // TODO: Try as sound effect
