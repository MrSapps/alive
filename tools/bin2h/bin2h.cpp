...
int main(int argc, char** argv)
{
    ...
    const std::string generated = "// This header was generated by a tool, any local changes will be lost";
    outFile.write(generated.data(), generated.length());
    outFile << std::endl;
    outFile << std::endl;

    // Write the generated header
    const std::string headerStart("const static unsigned char " + std::string(argv[3]) + "[] =");
