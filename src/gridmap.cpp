...
void GridMap::Update(const InputState& input)
{
    ...
    {
        CollisionLine* line = CollisionLine::Pick(mCollisionItems, { input.mMousePosition.mX + mCameraPosition.x, input.mMousePosition.mY + mCameraPosition.y });
        if (line)
        {
